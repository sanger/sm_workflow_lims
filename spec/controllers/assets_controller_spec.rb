...
describe AssetsController do
  ...
  context "index" do
    ...
    it "should look up all in progress assets"
    it "should return an assets index presenter"
    it "should pass a nil search parameter to the presenter"
    it "should pass the assets to the presenter"
  end
  ...
  context "index with parameters" do
    ...
    it "should look up all assets with an identifier"
    it "should return an assets index presenter"
    it "should pass a search parameter to the presenter"
    it "should pass the assets to the presenter"
  end
