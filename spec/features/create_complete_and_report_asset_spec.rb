...
feature 'create complete and report assets', js: true do
  ...
  let!(:workflow2) { create(:workflow_with_report, flow:(create :flow_with_steps), name: 'Reportable workflow') }
  ...
  scenario 'can create and complete a non-reportable asset' do
    ...
    expect(page).to have_content "123 was marked as completed."
  ...
  scenario 'can create, complete and report a reportable asset' do
    ...
    check 'complete[2]'
    click_on 'Completed selected'
    expect(page).to have_content "456 was marked as completed."
