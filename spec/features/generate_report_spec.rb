...
feature 'can generate report', js: true do
  ...
  let!(:asset2) { create :asset, workflow: workflow1, study: 'Study1', project: 'Project2' }
  ...
  scenario 'can generate report' do
    ...
    within('table#report') do
      ...
      expect(page).to have_text("1 Study1 Project1 No cost code 1")
      expect(page).to have_text("2 Study1 Project2 No cost code 1")
    end
