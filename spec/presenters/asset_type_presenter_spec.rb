...
describe 'Presenter::AssetTypePresenter::AssetType' do
  describe '#validates_with' do
    ...
    let(:presenter) { Presenters::AssetTypePresenter::AssetType.new(asset_type) }
    ...
    context 'when identifier_data_type is alphanumeric' do
      ...
      it 'returns the correct validation for the identifier data type' do
        expect(presenter.validates_with).to eq Presenters::AssetTypePresenter::AssetType::ALPHANUMERIC_REGEX
      end
    end
    ...
    context 'when identifier_data_type is numeric' do
      ...
      it 'returns the correct validation for the identifier data type' do
        expect(presenter.validates_with).to eq Presenters::AssetTypePresenter::AssetType::NUMERIC_REGEX
      end
    end
  end
end
