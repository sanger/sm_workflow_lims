class Batch
  class Updater
    ...
    def asset_params
      { study_id: study.id, project_id: project.id, workflow_id: workflow.id, pipeline_destination_id: pipeline_destination.id,
        cost_code_id: cost_code.id, comment_id: comment_object.id }.tap do |params|
